...
const ProfileSetupForm = ({ onSave }) => {
  ...
  const jurisdictions = [
    ...
    'Germany', 'France', 'Singapore', 'Hong Kong', 'Japan', 'Brazil',
    'Mexico', 'South Africa', 'Nigeria', 'Kenya', 'UAE', 'Saudi Arabia', 'Other'
  ];

  const practiceAreas = [
    'Corporate Law', 'Criminal Law', 'Family Law', 'Immigration Law',
    'Intellectual Property', 'Employment Law', 'Real Estate Law', 'Tax Law',
    'Contract Law', 'Litigation', 'Regulatory Compliance', 'Mergers & Acquisitions',
    'Securities Law', 'Banking & Finance', 'Environmental Law', 'Healthcare Law',
    'Technology Law', 'International Law', 'Constitutional Law', 'Administrative Law', 'Other'
  ];

  const organizationTypes = [
    'Law Firm', 'Corporate Legal Department', 'Government Agency',
    'Non-Profit Organization', 'Solo Practice', 'Legal Tech Company',
  ...
  const languages = [
    ...
    'Japanese', 'Hindi', 'Arabic', 'Portuguese', 'Other'
  ];
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#21C1B6] focus:border-transparent text-black"
    ...
    <div className="space-y-4">
      <div>
        ...
        <select
          ...
          className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#21C1B6] bg-white text-black"
        >
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">Primary Jurisdiction(s)</label>
  ...
  const renderStep3 = () => (
    <div className="space-y-4">
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-3">Preferred Tone of Voice</label>
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-3">Preferred Citation Style</label>
        <div className="space-y-2">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">My Perspective</label>
        <textarea
          value={myPerspective}
          onChange={(e) => setMyPerspective(e.target.value)}
          rows={4}
          className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#21C1B6] resize-none text-black"
          placeholder="Describe your legal perspective, approach, or philosophy..."
        />
      </div>
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">My Typical Client Profile</label>
        <textarea
          value={clientProfile}
      ...
      <div className="flex items-center justify-between pt-4 border-t border-gray-200">
        ...
        <div className="flex gap-3">
          {currentStep < 4 ? (
            <button
              onClick={handleNext}
              className="flex items-center gap-2 px-6 py-2 text-sm font-medium text-white bg-[#21C1B6] rounded-lg hover:bg-[#1AA49B] shadow-md"
            >
              Continue
            ...
            <button
              onClick={handleSave}
              disabled={isSaving}
              className="px-6 py-2 text-sm font-medium text-white bg-[#21C1B6] rounded-lg hover:bg-[#1AA49B] disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
            >
